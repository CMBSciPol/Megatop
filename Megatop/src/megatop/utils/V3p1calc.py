...
class CustomSAT(SOTel):
    ...
    def __init__(
        ...
        self.survey_years = survey_years
        self.survey_efficiency = survey_efficiency
        self.tube_configs = {"custom": np.array(sensitivities)}
        ...
        self.Patmos_alpha = np.asarray(alpha_knee)
        self.Patmos_ell = np.asarray(ell_knee)

        self.precompute(N_tubes=[("custom", N_tubes)])
