...
PARAM_FILE="/home/cgubeno/Megatop/paramfiles/planck_npipe_masked_debug.yaml"
...
# echo "------------------------------------------------------------"
# PREPROC_NP=16
# mpirun -n ${PREPROC_NP} megatop-preproc-run --config ${PARAM_FILE}
# echo ""
# echo ""
...
# echo "------------------------------------------------------------"
# mpirun -n 8 megatop-compsep-run --config ${PARAM_FILE}
# echo ""
# echo ""
...
echo "------------------------------------------------------------"
mpirun -n 8 megatop-noisespectra-run --config ${PARAM_FILE}
echo ""
echo ""
