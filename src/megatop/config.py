...
class MapSetConfig(StrictModel):
    ...
    external_sky_map: ExternalSkyMapConfig | None = None
    """If set, sky sim maps for this map_set are read from disk instead of generated by the
    mocker (`mock_signal` step is skipped for this map_set)."""
