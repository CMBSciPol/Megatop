...
from fgbuster.separation_recipes import _format_alms, _r_to_c_alms  # noqa: E402
...
def megabuster_comp_sep(
    ...
    assert solver_name in SOLVER_NAMES.__args__, (
        f"Solver name must be one of {SOLVER_NAMES.__args__}."
    )
